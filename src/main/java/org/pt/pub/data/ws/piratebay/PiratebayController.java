package org.pt.pub.data.ws.piratebay;

import org.pt.pub.data.ws.domain.WebResult;
import org.pt.pub.data.ws.piratebay.domain.PirateBayRequest;
...
public class PiratebayController {
    ...
    @RequestMapping(value = "/torrents", method = RequestMethod.POST, consumes = "application/json")
    @Cacheable("cache")
